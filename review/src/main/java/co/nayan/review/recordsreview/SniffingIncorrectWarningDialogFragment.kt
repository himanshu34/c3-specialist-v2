...
import co.nayan.review.databinding.LayoutSniffingWarningBinding
...
class SniffingIncorrectWarningDialogFragment : DialogFragment() {
    ...
    private lateinit var binding: LayoutSniffingWarningBinding
    ...
    companion object {
        ...
        fun newInstance(message: String): SniffingIncorrectWarningDialogFragment {
            val args = Bundle()
    ...
    override fun onCreateView(
        ...
        return LayoutSniffingWarningBinding.inflate(inflater, container, false).apply {
            binding = this
        }.root
    }

    fun setViewModel(viewModel: ReviewViewModel) {
