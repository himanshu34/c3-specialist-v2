 ...
 * Implemented from : https://github.com/Manuiq/ZoomableTextureView/blob/master/app/src/main/java/ua/polohalo/zoomabletextureview/sample/ZoomableExoPlayerView.java
 */
public class ZoomableExoPlayerView extends FrameLayout {
    ...
    private CustomZoomableTextureView customZoomableTextureView;
    ...
    private ZoomableViewInteractor zoomableViewInteractor;
    ...
    public ZoomableExoPlayerView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (contentFrame != null && surfaceType != SURFACE_TYPE_NONE) {
            ...
            customZoomableTextureView = new CustomZoomableTextureView(context);
            surfaceView = customZoomableTextureView;
    ...
    public Bitmap getPlaybackScreenshot() {
        return customZoomableTextureView.getPlaybackScreenshot();
    }
     ...
     *
     * @param message The message to display, or {@code null} to clearBuffer a previously set message.
     */
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        if (ev.getAction() == MotionEvent.ACTION_UP && zoomableViewInteractor != null) {
    ...
    public void setZoomableViewInteractor(ZoomableViewInteractor zoomableViewInteractor) {
        this.zoomableViewInteractor = zoomableViewInteractor;
        customZoomableTextureView.setZoomableViewInteractor(zoomableViewInteractor);
    }
