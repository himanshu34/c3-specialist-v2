...
public class CircularEncoderBuffer {
    ...
    private static final String TAG = "CircularEncodeBuffer";
    ...
    public CircularEncoderBuffer(int bitRate, int frameRate, int desiredSpanSec) {
        ...
        Timber.tag(TAG).d("CBE: bitRate=" + bitRate + " frameRate=" + frameRate +
    ...
    public void add(ByteBuffer buf, int flags, long ptsUsec) {
        ...
        //Timber.tag(TAG).d("Circular Buffer Check add() mMetaHead :%s metaLen: %s mMetaTail  :%s", mMetaHead, metaLen, mMetaTail);
        if (EXTRA_DEBUG) {
    ...
    private void removeTail() {
        ...
        //Timber.tag(TAG).d("Circular Buffer Check removeTail()mMetaTail  :%s metaLen :%s, metaHead:%s", mMetaTail, metaLen, mMetaHead);
    }
}
