package co.nayan.c3specialist_v2.performance.specialistperformance

import android.os.Bundle
import co.nayan.c3specialist_v2.R
import co.nayan.c3specialist_v2.databinding.ActivitySpecialistPerformanceBinding
...
@AndroidEntryPoint
class SpecialistPerformanceActivity : PerformanceActivity() {

    private val binding: ActivitySpecialistPerformanceBinding by viewBinding(
        ActivitySpecialistPerformanceBinding::inflate
    )
    ...
    private val onIncorrectClickListener = object : OnIncorrectClickListener {
        override fun onIncorrectAnnotationClicked() {
            moveToIncorrectRecordsScreen(WorkType.ANNOTATION, Role.SPECIALIST)
        }

        override fun onIncorrectJudgmentClicked() {
            moveToIncorrectRecordsScreen(WorkType.VALIDATION, Role.SPECIALIST)
        }
    ...
    override fun fetchPerformance(startDate: String, endDate: String) {
        performanceViewModel.fetchSpecialistPerformance(startDate, endDate)
    }
