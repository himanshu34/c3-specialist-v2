...
@HiltViewModel
class SpecialistWorkSummaryViewModel @Inject constructor(
    private val specialistWorkSummaryRepository: SpecialistWorkSummaryRepository
) : BaseViewModel() {
    ...
    fun fetchWorkSummary(startDate: String, endDate: String) {
        viewModelScope.launch(exceptionHandler) {
            ...
            val response = specialistWorkSummaryRepository.fetchWorkSummary(
