...
-keep class dji.sdk.camera.VideoFeeder.**{*;}
-keep interface dji.sdk.camera.VideoFeeder.**{*;}
-keep class dji.sdk.camera.VideoFeeder.VideoDataListener.**{*;}
-keep public interface dji.sdk.camera.VideoFeeder$VideoDataListener {*;}
#<------------ utmiss config start------------>
