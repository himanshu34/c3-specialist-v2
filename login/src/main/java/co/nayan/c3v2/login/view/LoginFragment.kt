...
import co.nayan.c3v2.login.BuildConfig
...
import co.nayan.c3v2.login.databinding.LoginFragmentBinding
...
class LoginFragment : BaseFragment(R.layout.login_fragment) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.tvForgotPasswordLabel.setOnClickListener {
            childFragmentManager.showDialogFragment(ForgotPasswordDialogFragment.newInstance())
        }
        ...
        binding.tvSignUp.colorSpannableStringWithUnderLineOne(
        ...
        if (BuildConfig.DEBUG) setDefaultInputValues()
    ...
    private fun logoutSocialLogins() = lifecycleScope.launch {
        try {
            // Logout Google
    ...
    private fun moveToNextScreen(user: User) {
    ...
    private fun setDefaultInputValues() {
        binding.emailInput.setText(String.format("user@example.com"))
        binding.passwordInput.setText(String.format("password"))
    }
